...
<div class="slide slide-cover">
  ...
  <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 14pt; width: 100%; max-width: 760pt; text-align: left;">
    ...
    <div class="card" style="background: #f1f5f9; padding: 14pt 16pt;">
      ...
      <div style="font-size: 8.5pt; color: #475569;">
        Plantas executivas e esquemas de rede desenvolvidos por cada dupla.
      </div>
    </div>
...
<!-- ==========================================
     SLIDE 2: VISÃO GERAL & CONTEXTO PORTUÁRIO
     ========================================== -->
<div class="slide">
  <div class="badge badge-blue">CONTEXTO ESTRATÉGICO</div>
  <div class="slide-title">Contexto Portuário & Missão Crítica</div>
  <div class="slide-subtitle">
    O Terminal do Itaqui é o maior canal de escoamento de grãos do Arco Norte. A rede de telecomunicações atua com 99,999% de disponibilidade para evitar paradas que geram severas penalidades financeiras.
  </div>
  ...
  <div class="grid-4" style="margin-bottom: 10pt;">
    <div class="card">
      ...
      <ul class="bullet-list">
        <li>Profundidade natural para gigantes <strong>Panamax</strong> e <strong>Capesize</strong>.</li>
        <li>Marés de até 7m exigem sincronia contínua de atracação.</li>
      </ul>
    </div>
    ...
    <div class="card">
      ...
      <ul class="bullet-list">
        <li><strong>3,7 milhões de ton/mês</strong> de soja e milho escoados.</li>
        <li>Convergência rodoferroviária ininterrupta no cais.</li>
      </ul>
    </div>
    ...
    <div class="card">
      ...
      <ul class="bullet-list">
        ...
        <li>Falhas de rede paralisam faturamento e balanças.</li>
      </ul>
    </div>

    <div class="card">
      <div class="card-header" style="color: #7e22ce;">
        <span>🛡️</span> Ambiente Hostil
      </div>
      <ul class="bullet-list">
        <li>Maresia extrema, umidade salina e pó de grãos (Zona Ex).</li>
        <li>Equipamentos em armários <strong>IP66/IP67</strong> de inox.</li>
      </ul>
    </div>
  </div>
  ...
  <div class="card" style="background: #f8fafc; padding: 8pt 14pt;">
    ...
    <div style="font-size: 7.5pt; color: #475569;">
      Backbone em Fibra Monomodo OS2 • Switches PoE+ com redundância • 8 VLANs isoladas • Cabeamento Cat6 100% Cobre • Nobreaks UPS senoidais em todos os racks remotos.
    </div>
  </div>
...
<div class="slide">
  ...
  <div class="slide-subtitle">
    Consolidação de investimentos em ativos e infraestrutura de rede das 5 áreas operacionais (pesquisa de mercado de setembro de 2026).
  </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      <div class="card">
        ...
        <table class="table-compact">
          ...
          <tbody>
            <tr><td>Prédio Administrativo TP</td><td style="text-align: right; font-family: 'JetBrains Mono'; font-weight: 600;">R$ 708.624,00</td></tr>
...
<!-- ==========================================
     SLIDE 4: TOPOLOGIA GERAL DE CAMPUS
     ========================================== -->
<div class="slide">
  <div class="badge">BACKBONE ÓPTICO</div>
  <div class="slide-title">Topologia Física Geral de Campus</div>
  <div class="slide-subtitle">
    Arquitetura em estrela centralizada no CCO. Todos os setores conectam-se via fibra monomodo OS2 subterrânea imune a ruídos eletromagnéticos industriais.
  </div>
  ...
  <div class="grid-2">
    ...
    <div class="card" style="padding: 6pt; background: #ffffff;">
      <div style="height: 195pt; display: flex; align-items: center; justify-content: center;">
        <svg viewBox="0 0 460 250" style="width: 100%; height: 100%;">
          ...
          <text x="230" y="136" font-size="7.5" fill="#38bdf8" text-anchor="middle">Core L3 & Gateway Central</text>
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      <div class="card">
        <div class="card-header" style="font-size: 9pt;">Pilares de Conectividade do Campus</div>
        <ul class="bullet-list" style="margin-top: 2pt;">
          <li><strong>Enlaces Monomodo OS2:</strong> 10 Gbps pronto, sem limite prático de distância.</li>
          <li><strong>Tolerância a Falhas:</strong> Topologia estelar sem loops de camada 2.</li>
          <li><strong>Dutos Subterrâneos PEAD:</strong> Blindagem física contra máquinas pesadas e calor.</li>
        </ul>
      </div>

      <div class="card" style="flex: 1;">
        <div class="card-header" style="font-size: 9pt;">Volume Total de Ativos Conectados</div>
...
<div class="slide">
  ...
  <div class="slide-title">Prédio Administrativo: Topologia & Ativos</div>
  <div class="slide-subtitle">
    Hub central corporativo com 108 pontos Cat6, servidores de aplicação portuária e rede sem fio corporativa Wi-Fi 6.
  </div>
  ...
  <div class="grid-sector">
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      <div class="card">
        <div class="card-header" style="color: #7e22ce;">🏢 Ativos de Campo</div>
        <ul class="bullet-list">
          ...
          <li><strong>Storage:</strong> 1 SAN/NAS dedicado (rede isolada 10 Gb/s).</li>
          <li><strong>Wi-Fi:</strong> 4 Access Points Wi-Fi 6 corporativos.</li>
          <li><strong>Pontos:</strong> 108 pontos Cat6 nos 2 pavimentos.</li>
        </ul>
      </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      <div class="card">
        ...
        <ul class="bullet-list">
          ...
          <li><strong>Uplink:</strong> Par de fibra OS2 direto ao CCO (450 metros).</li>
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      <div class="card">
        ...
        <ul class="bullet-list">
          ...
          <li><strong>Uplink:</strong> 850m de fibra OS2 subterrânea até o CCO.</li>
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      <div class="card">
        ...
        <ul class="bullet-list">
          ...
          <li><strong>Uplink:</strong> Fibra OS2 600m imune a ruídos EMI de locomotivas.</li>
          ...
          <li><strong>Gabinete:</strong> Armários de inox 316 com coxins antivibração.</li>
        </ul>
      </div>
...
<div class="slide">
  ...
  <div class="slide-title">Berço 098 / CCO: Núcleo L3 & Centro de Controle</div>
  <div class="slide-subtitle">
    Centro nevrálgico do complexo portuário e comando de cais. Concentra o Core L3, terminação de fibras e gravação NVR.
  </div>
  ...
  <div class="grid-sector">
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      <div class="card">
        <div class="card-header" style="color: #0f172a;">⚓ Núcleo de Rede</div>
        <ul class="bullet-list">
          <li><strong>Core L3:</strong> 1× Cisco Catalyst 3650 (Roteamento entre VLANs).</li>
          <li><strong>Borda:</strong> 1× Cisco ISR 4331 com redundância WAN e Firewall.</li>
          <li><strong>NVR:</strong> Central 32 Canais (64 TB RAID 5 - Gravação contínua).</li>
          <li><strong>Cais:</strong> 4 Câmeras PTZ 40x monitorando atracação de navios.</li>
          <li><strong>VoIP:</strong> 5 Telefones IP para coordenação rádio e terra.</li>
        </ul>
      </div>

      <div class="card" style="flex: 1;">
        <div class="card-header" style="color: #0284c7;">🧠 Funções Centrais</div>
        <ul class="bullet-list">
          <li><strong>Gateways SVIs:</strong> Terminação de todas as 8 VLANs do campus.</li>
          <li><strong>DHCP Server:</strong> Pools dedicados por escopo setorial.</li>
          <li><strong>Trunks 802.1Q:</strong> Enlaces ópticos para os 4 setores remotos.</li>
          <li><strong>QoS:</strong> Voz (VLAN 20) e Automação (VLAN 70) priorizados.</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 8pt;">
      ...
      <div class="card" style="flex: 1; background: #f0fdf4; border-color: #bbf7d0;">
        ...
        <div style="font-size: 7.5pt; color: #166534; line-height: 1.4;">
          ...
          ✓ Falhas de DHCP/APIPA eliminadas com pools centralizados no Core L3.<br>
    ...
    <div style="display: flex; flex-direction: column; gap: 6pt;">
      <div class="grid-2" style="gap: 6pt;">
        <div class="card" style="padding: 8pt 10pt;">
          ...
          <div style="font-size: 7pt; color: #475569; margin-top: 1pt;">Backbone em fibra óptica OS2 unindo os 5 setores ao CCO.</div>
        </div>
        <div class="card" style="padding: 8pt 10pt;">
...
if os.path.exists(PDF_OUTPUT):
    ...
    print(f"\nPDF ULTRA RESUMIDO GERADO COM SUCESSO!")
    print(f"  Arquivo: {os.path.basename(PDF_OUTPUT)}")
    print(f"  Tamanho: {os.path.getsize(PDF_OUTPUT)} bytes")
    print(f"  Total de Paginas (Slides): {len(doc)}")
    for i, p in enumerate(doc):
        w, h = p.get_size()
        print(f"    Slide {i+1}: dimensao ({w:.2f}, {h:.2f}) pt - Ratio {w/h:.4f}")
else:
