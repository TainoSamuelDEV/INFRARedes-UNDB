...
<body>
        ...
        <div class="card" style="margin-bottom: 16px;">
          <table class="slide-table">
            <thead>
              <tr>
                <th>Categoria</th>
                <th>Especificação / Modelo de Referência</th>
                <th>Qtd</th>
                <th>Finalidade Principal</th>
                <th>Investimento Est. (R$)</th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              <tr>
                ...
                <td>Cisco Industrial IE-3000 / Ruggedized IP67</td>
                <td>3 un</td>
                <td>Silo de Grãos, Pera Férrea e Cais do Berço 098</td>
                <td>R$ 54.000,00</td>
              </tr>
              <tr>
              ...
              <tr>
                <td><strong>Passivos & Racks</strong></td>
                <td>Racks 42U/24U Fechados, Patch Panels Cat6, DIOs e No-breaks</td>
                <td>Lote</td>
  ...
  <script>
    (function() {
      ...
      btnLast.addEventListener('click', () => goToSlide(totalSlides - 1));

      btnNotesToggle.addEventListener('click', () => toggleNotes());
      btnCloseNotes.addEventListener('click', () => toggleNotes(false));

      btnOverviewToggle.addEventListener('click', () => toggleOverview());
...
"""
    ...
    out_path = "Apresentacao-Terminal-Portuario-UNDB.html"
